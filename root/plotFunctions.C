...
TH2D *getDetYieldEDist(int zip,int bins=100,double xmin=0.0, double xmax=5.0, string file="/data/chocula/villaa/PhotoN_SuperSim/ZipSum/sbbe_trees.root",bool resave=false)
{
